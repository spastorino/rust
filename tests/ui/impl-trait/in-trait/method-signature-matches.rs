...
impl TooMuch for () {
    ...
    //~^ ERROR method `calm_down_please` has an incompatible type for trait [E0053]
}
...
impl TooLittle for () {
    ...
    //~^ ERROR method `come_on_a_little_more_effort` has an incompatible type for trait [E0053]
}
